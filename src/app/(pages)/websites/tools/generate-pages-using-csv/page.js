...
const GeneratePagesUsingCsv = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (userCredits !== null && userCredits > 0 && file) {
      ...
      setLoading(true);
      try {
        const response = await websiteService.submitPromptUsingCsv(formData);
      ...
      <div className="container py-5" style={{ minHeight: "100vh" }}>
        <div className="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
          <h4 className="text-uppercase font-weight-bold text-dark">
            ...
            <CgWebsite className="me-2" /> Generate Pages Using CSV
          </h4>
                  ...
                  >
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        >
                          <li>
                            <strong>prompt</strong>: The prompt or content to be
                            generated.
                          </li>
                          <li>
                          ...
                          <li>
                            <strong>site</strong>: The specific website
                            associated with the content.
                          </li>
                          <li>
                            <strong>article_dir</strong>: The directory path
                            where articles will be stored. By default it should
                            be "na".
                          </li>
                        </ul>
                      </div>
